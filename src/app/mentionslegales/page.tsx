        ...
        <article id="mentions">
            <div className="container-root">
                <div className="wrapper">
                    <BackButton color="#fafafa" path="" backcolor="#F94949"/>
                    ...
                    <ol>
                        ...
                        <li>
                            ...
                            <p className="text">Le contenu de ce site (textes, images, vidéos, etc.) est protégé par le
                                droit d&apos;auteur et appartient à Unred sauf mention contraire. Toute
                                reproduction, diffusion ou utilisation non autorisée est strictement interdite.</p>
                        </li>
                        <li>
                            ...
                            <p className="text">Mobalicorps peut collecter des données personnelles, telles que nom,
                                prenom, numero de telephone, adresse e-mail, lorsque les utilisateurs remplissent un formulaire de contact. Ces
                                données seront utilisées uniquement dans le but de fournir les services demandés. Unred ne
                        ...
                        <li>
                            ...
                            <p className="text">Unred ne peut être tenu responsable des erreurs ou omissions sur
                                le site. Les informations fournies sont à titre indicatif et peuvent être modifiées sans
                                préavis.</p>
                        </li>
                        <li>
                            <h3 className="title_h3">Liens Externes</h3>
                            <p className="text">Ce site peut contenir des liens vers des sites externes. Unred ne
